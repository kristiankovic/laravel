{{-- Componentes personalizados para solo llamarlos desde las vistas --}}
{{-- COMPONENTES ANONIMOS --}}

@props(['title' => '', 'body' => '', 'type' => 'info'])
...
{{-- CONCATENAR LOS ATRIBUTOS DE UNA CLASE --}}
